...
system_prompt = (
    ...
    "Base professional answers strictly on the CV content, but do not be harsh -- be very polite and patient, and make small talk if initiated by the user, do not be too rigid or solemn:). "
